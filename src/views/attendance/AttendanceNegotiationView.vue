    ...
    <template v-else-if="!propostaPendente && !cancelando">
      <div class="max-w-2xl mx-auto">
        ...
        <div v-if="contract && !contract.acordoAtivo" class="card mb-6">
          ...
          <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Como montar o plano?</p>          <div class="flex rounded-xl border border-gray-200 overflow-hidden mb-5">
            <button
              type="button"
              class="flex-1 py-2.5 text-sm font-medium transition-colors flex items-center justify-center gap-1.5"
              :class="modoCalculo === 'entrada'
            ...
            <button
              type="button"
              class="flex-1 py-2.5 text-sm font-medium transition-colors border-l border-gray-200 flex items-center justify-center gap-1.5"
              :class="modoCalculo === 'parcela'
                ? 'bg-teal-600 text-white'
                : 'text-gray-600 hover:bg-gray-50'"
