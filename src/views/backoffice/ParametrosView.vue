        ...
        <div class="p-5 grid sm:grid-cols-2 gap-5">
          <div>
            ...
            <div class="flex items-center gap-3">
              <input v-model.number="entradaMinimaPct" type="range" min="5" max="50" step="1" class="flex-1 accent-blue-500" />
              <span class="text-sm font-bold text-blue-600 w-12 text-right">{{ entradaMinimaPct }}%</span>
            </div>
          ...
          <div>
            ...
            <div class="flex items-center gap-3">
              <input v-model.number="parcelasMaxAutoAprovacao" type="range" min="3" max="36" step="1" class="flex-1 accent-blue-500" />
              <span class="text-sm font-bold text-blue-600 w-12 text-right">{{ parcelasMaxAutoAprovacao }}x</span>
            </div>
          ...
          <div>
            ...
            <div class="flex items-center gap-3">
              <input v-model.number="atrasoMaxAutoAprovacao" type="range" min="15" max="180" step="5" class="flex-1 accent-blue-500" />
              <span class="text-sm font-bold text-blue-600 w-12 text-right">{{ atrasoMaxAutoAprovacao }}d</span>
            </div>
      ...
      <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div class="p-5 grid sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <div class="flex items-center gap-3">
              <input v-model.number="prazoEntradaHoras" type="range" min="12" max="120" step="6" class="flex-1 accent-blue-500" />
        ...
        <div class="p-5">
          <div class="space-y-3">
            <div v-for="f in faixas" :key="f.faixa" class="flex items-center gap-4">
              ...
              <input v-model.number="f.valor" type="range" min="0" max="50" step="1" class="flex-1 accent-blue-600" />
              <span class="text-sm font-bold text-blue-700 w-12 text-right">{{ f.valor }}%</span>
            </div>
          </div>
          <!-- Barra visual -->
