  ...
  >
    ...
    <template v-else>
      ...
      <Teleport to="body">
        ...
        <div v-if="negotiation.status === 'contraproposta'" class="mt-4 rounded-xl bg-amber-50 border border-amber-200 px-4 py-3 text-xs flex items-start justify-between gap-3">
          <div class="flex items-start gap-1.5">
        ...
        <div v-if="negotiation.status === 'quitado'" class="mt-4 rounded-xl bg-green-50 border border-green-200 px-4 py-4 flex items-start gap-3">
