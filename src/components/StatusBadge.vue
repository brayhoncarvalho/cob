...
const MAP = {
  ...
  renegociado:  { label: 'Renegociado',  cls: 'bg-blue-100 text-blue-800' },
  em_analise:   { label: 'Em análise',   cls: 'bg-amber-100 text-amber-800' },
  em_pagamento: { label: 'Em pagamento', cls: 'bg-blue-100 text-blue-800' },
  ...
  contraproposta: { label: 'Contraproposta', cls: 'bg-amber-100 text-amber-800' },
  pending_client_approval: { label: 'Aguardando cliente', cls: 'bg-amber-100 text-amber-800' },
  paga:         { label: 'Paga',         cls: 'bg-green-100 text-green-800' },
  quitado:      { label: 'Quitado',      cls: 'bg-green-100 text-green-800' },
